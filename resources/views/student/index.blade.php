                    ...
                    <div class="card-body">
                        ...
                        <table class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <td>
                                    <a href="{{ url('/student/edit',$list->slug) }}" class="btn btn-info">Edit</a>
                                    <a href="{{ url('student/delete',$list->id) }}" class="btn btn-danger" onclick="return confirm('Are You Sure You Want To Delete This Item Y/N ?')">Delete</a>
                                </td>
                                </tr>
                                @endforeach
                            </tbody>
